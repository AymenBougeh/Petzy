...
class SettingScreen2 extends BaseRoute {
  // SettingScreen() : super();
  SettingScreen2({a, o}) : super(a: a, o: o, r: 'SettingScreen2');
  @override
  _SettingScreen2State createState() => new _SettingScreen2State();
}

class _SettingScreen2State extends BaseRouteState {
  _SettingScreen2State() : super();
  @override
  void initState() {
    super.initState();
    getconnId();
            ...
            child: Column(
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                      color: Colors.transparent,
                      margin: EdgeInsets.only(top: 410, bottom: 10),
                      // color: Colors.red,
                      width: MediaQuery.of(context).size.width,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
