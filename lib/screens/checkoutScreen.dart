...
class _ChekoutScreenState extends BaseRouteState {
  ...
  void getWorkerId() async {
    ...
    valueForNumber = prefs.getString("phone");
    valueForEmail = prefs.getString("email");

    print(connId);
    print(valueForNumber);
  }
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: TextButton(
                                    ...
                                    onPressed: () {
                                      print('Hello');
                                      _apiUtils.deleteAllProdFromcart(connId);
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'THANK YOU',
                style:
                    TextStyle(fontSize: 20), // Adjust the font size as needed
              ),
            )
          ],
        ),
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        title: Text(index == 0 ? 'Master Card ' : 'Visa ',
