...
var response, name, email, phone, password, selectedServices;
...
class _SIgnUpScreenState extends BaseRouteState {
  ...
  void getService() async {
    ...
    selectedServices = prefs.getString('selectedServices');
          ...
          children: [
            Container(
                ...
                child: TextButton(
                    ...
                    onPressed: () async {
                      // print('Hello');
                      if (selectedServices == "Pet Bording" ||
                          selectedServices == "Dog Walking") {
                        response = await http.post(
                          Uri.parse(Api.urlAddWorker),
