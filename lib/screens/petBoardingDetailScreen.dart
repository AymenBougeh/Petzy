...
class _PetBoardoingDetailScreenState extends BaseRouteState {
  ...
  Future<void> fetchBordet() async {
    final bor = await _apiUtils.getAllWorker();
    final filteredBor = bor.where((det) => det.workerId == workerId).toList();
    setState(() {
      borDet = filteredBor;
    });
  }
                          ...
                          child: Container(
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                  radius: 80,
                                  backgroundImage:
                                      NetworkImage(borDet[index].image ?? "")),
                            ),
                          ),
                        ),
                        Positioned(
